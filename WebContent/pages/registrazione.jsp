	...
	<div>
		<form action="../Registrazione" method="post">
			...
			<label for="cognome">Cognome:</label> <input type="text" id="cognome"
				...
				for="indirizzo">Indirizzo:</label> <input type="text" id="indirizzo"
				name="indirizzo" required><br> <br> <label
				for="cellulare">Cellulare:</label> <input type="text" id="cellulare"
				name="cellulare" required><br> <br>
